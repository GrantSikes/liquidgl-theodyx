    ...
    _initGL() {
      ...
      const fsSource = `
        ...
        void main(){
          ...
          vec2 _pe = (v_uv - 0.5) * u_resolution;
          vec2 _be = 0.5 * u_resolution;
          vec2 _qe = abs(_pe) - _be + u_radius;
          vec2 _nrm = sign(_pe) * normalize(max(_qe, vec2(0.001)));
          vec2 offset = _nrm * offsetAmt;
