/* theodyx-cookies 1.4.0 (Phase 6): strings via the locale runtime (window.__thxI18n, keyed by <html lang>, English fallback); logical CSS properties. */
...
function footLink(){
  ...
  a.href='#cookie-preferences';a.textContent=T('ck.footer');a.className=target.className;
