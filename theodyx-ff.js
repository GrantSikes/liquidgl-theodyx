/*! theodyx-ff.js v1.3.4 (2026-09-16) — the Freshfields-pattern runtime for theodyx.com.
...
(function () {
  ...
  var API = window.__thxFF = { v: '1.3.4' };
  ...
  (function css() {
    ...
    ink.textContent = [
      ...
      'form.ff-form-modern textarea,form.ff-form-modern textarea.w-input,form.ff-form-modern textarea.text-area{background:#fff!important;border:1px solid rgba(13,13,13,.22)!important;border-radius:12px!important;box-shadow:none!important;height:auto!important;min-height:140px!important;padding:14px 16px!important;font-family:' + SANS + '!important;font-size:16px!important;color:#0d0d0d!important}form.ff-form-modern :is(input,select,textarea):focus{border-color:#0d0d0d!important;box-shadow:0 0 0 3px rgba(13,13,13,.08)!important}',
