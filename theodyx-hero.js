...
(function () {
  ...
  var CSS =
    ...
    ".hero-vlabel span{writing-mode:vertical-rl;text-orientation:mixed;font-family:'Sinhala Sangam MN',serif;font-weight:700;font-size:clamp(44px,7vw,128px);text-transform:uppercase;color:#1b1916;opacity:.9;line-height:1;user-select:none}" +
