/*! theodyx-thinking.js v1.3.1 (2026-09-13) — the Our Thinking system: editorial carousels (.thk-track), the hub's search +
...
(function () {
  ...
  var API = window.__thxThinking = { v: '1.3.1' };
  ...
  function carousel(track) {
    var list = track.querySelector('.thk-list') || track.querySelector('.w-dyn-items') || track.querySelector('[data-thk-list]'); if (!list) return; /* 1.3.1: a static strip (the homepage What we do cards) marks its list with data-thk-list */
