...
(async () => {
  ...
  if (run('head')) { const { page, ctx, errors } = await open('/about');
    ...
    check('head v4.13.0 banner is live', html.includes('Theodyx head code · v4.13.0'));
    ...
    for (const [f, sha] of [['theodyx-nav.js', 'd0aa0968895b32e04561eeab851f57cf5088df28'], ['nv2pagesf.js', 'd0aa0968895b32e04561eeab851f57cf5088df28'], ['theodyx-cookies.js', '8f07b13f736da64cb6b36af45800192ff3b6e3b3'], ['theodyx-article-fx.js', '1ada34cade7b358f3a40225a8913b5b8d7935a2d']]) {
